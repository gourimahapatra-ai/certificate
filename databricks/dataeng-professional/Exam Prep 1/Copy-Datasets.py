...
data_catalog = spark.sql("SELECT current_catalog()").collect()[0][0]
bookstore = CourseDataset(data_source_uri, "dbacademy", db_name)
...
dbutils.fs.cp("s3://dalhussein-courses/DE-Pro/datasets/bookstore/v1//books-updates-streaming/", "/Volumes/dbacademy/ops/labuser13431568_1773883293@vocareum_com/test/", True)
